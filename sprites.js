export const title = {
  ...
  svg: `<text x="50" y="15" text-anchor="middle" font-size="15" stroke-width="0.25">
          ${"穷舍怪人".split("").map((c, i) => `<tspan>${c}<animate attributeName="stroke-width" values="1;0.25" dur="2.0s" begin="${500 + i * 50}ms" /></tspan>`).join("")}
        </text>`,
...
export const end = {
  ...
  svg: `<text x="50" y="50" text-anchor="middle" font-size="15" stroke-width="0.25">
          ${"结束".split("").map((c, i) => `<tspan>${c}<animate attributeName="stroke-width" values="1;0.25" dur="2.0s" begin="${500 + i * 50}ms" /></tspan>`).join("")}
        </text>`,
  style: `fill: var(--c2); stroke: var(--c1);`
};
...
export const cs = {
  viewbox: "0 0 100 100",
  svg: `<text x="50" y="75" text-anchor="middle" font-size="5" stroke-width="0.2">
          ${matchMedia("(pointer:fine)").matches ? "点击" : "轻触"} 开始
        </text>
        <text x="50" y="85" text-anchor="middle" font-size="3" stroke-width="0.1">
          由LUMIN团队制作
        </text>`,
